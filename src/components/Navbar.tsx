      ...
      <div className="flex flex-col gap-3 mt-8">
        {settings?.links?.appStore && (
          <a
            ...
            className="flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-white text-black font-semibold hover:bg-gray-100 transition-all"
          >
        ...
        {settings?.links?.googlePlay && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-primary text-white font-semibold hover:bg-primary/90 transition-all"
          >
