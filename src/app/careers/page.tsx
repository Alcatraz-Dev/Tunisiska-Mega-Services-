  ...
  return (
    <div className="pt-24 pb-20 max-w-7xl mx-auto px-6">
      ...
      >
        ...
        <p className="text-xl text-gray-400">{t.careersPage.subtitle}</p>
      </motion.div>
      ...
      >
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 text-center">
          ...
          <h2 className="text-2xl font-semibold mb-4">{t.careersPage.openPositions}</h2>
          <p className="text-gray-400 mb-8">{t.careersPage.noPositions}</p>
          <div className="inline-block bg-white/5 rounded-xl p-6 border border-white/10">
            <p className="text-gray-300">{t.careersPage.sendResume}</p>
          </div>
        </div>
      </motion.div>
    </div>
